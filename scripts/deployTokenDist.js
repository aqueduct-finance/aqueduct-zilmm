...
const SUPER_TOKEN_ADDRESS = "0x220aF5894e183168E3E3f9dA9cde9Ae812c551Db"; // fDAIxp
...
const main = async () => {
    ...
    const tokenDist = await TokenDist.deploy(SUPERFLUID_HOST, SUPER_TOKEN_ADDRESS, DIST_DISCRETE_AMOUNT, DIST_FLOW_RATE);
